...
import { GRAboutItem } from "@/components/GRAbout/GRAbout";
import { GRCardProps } from "@/components/GRCard/GRCard";
import { GRFooterProps } from "@/components/GRFooter/GRFooter";
import { GRNavbarItem } from "@/components/GRNavbar/GRNavbar";

export interface GREmpresaType {
  nome: string;
  navbarItens: GRNavbarItem[];
  heroText: string;
  textos: GRAboutItem[];
  services: GRCardProps[];
  footer: GRFooterProps;
...
export default function GREmpresa() {
